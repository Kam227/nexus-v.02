    ...
    <View style={styles.postContainer}>
      ...
      <View style={styles.voteContainer}>
        <View style={styles.leftIconsContainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Report', {postId: post.postId})}>
            <Feather name="flag" size={24} color="black" style={styles.commentIcon} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handleToggleBookmark}>
              <Feather name="bookmark" size={24} color={isPostBookmarked ? '#f5d41a' : 'black'} style={styles.commentIcon} />
            </TouchableOpacity>
        ...
        <View style={styles.voteIconsContainer}>
            ...
            <TouchableOpacity onPress={handlePostVote}>
              <Feather
                ...
                size={24}
                color={
                  post.votes && Array.isArray(post.votes)
                    ? post.votes.find(vote => vote.userId === firebase.auth().currentUser?.uid && vote.value === 1)
                      ? 'green'
                      : 'black'
                    : 'black'
                }
